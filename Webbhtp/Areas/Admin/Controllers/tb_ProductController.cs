...
namespace Webbhtp.Areas.Admin.Controllers
{
    public class tb_ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductdID,Title,Alias,Image,Price,PriceSale,Quantity,IsNew,IsBestSeller,IsActive,CategoryProductId,describe,IsHome")] tb_Product tb_Product)
        {
